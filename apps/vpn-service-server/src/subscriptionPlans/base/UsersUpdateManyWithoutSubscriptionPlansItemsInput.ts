...
@InputType()
class UsersUpdateManyWithoutSubscriptionPlansItemsInput {
...
export { UsersUpdateManyWithoutSubscriptionPlansItemsInput as UsersUpdateManyWithoutSubscriptionPlansItemsInput };
